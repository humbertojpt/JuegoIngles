 ...
 */
public class EstudiarF4 extends Fragment {
    ...
    public static EstudiarF4 newInstance(int sectionNumber) {
        EstudiarF4 fragment = new EstudiarF4();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.estudiar_f4, container, false);

        final ImageView image_expert = (ImageView) root.findViewById(R.id.imageView4);
        final TextView texto = (TextView) root.findViewById(R.id.textImagen4);
